...
<body class="bbody">
	...
	<br>
	<p class="pintro">
		<strong> <%=fullname%>, ¡En hora buena! Eres beneficiario del apoyo
			económico<br> de $300.00 para alimentación de tú hogar.
		</strong>
	</p>
	<br>
	<p class="p2message">
		<strong>Tú pago podrá ser retirado en ventanilla,
		<br> en la entidades bancaria autorizadas en el lugar de tu residencia.
		</strong>
	</p>
	<br>
